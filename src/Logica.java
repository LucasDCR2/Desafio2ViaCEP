...
//==========================================================================< Buscar/END >============================================================================//
    ...
    public void buscarPorEndereco(BufferedReader reader) throws IOException {
...
//==========================================================================< Buscar/CEP >============================================================================//
    ...
    public void buscarPorCep(BufferedReader reader) throws IOException {
...
//==========================================================================< Consultar Endereço >====================================================================//
    ...
    private Map<String, String[]> consultarEndereco(String uf, String cidade, String logradouro) throws IOException {
...
//==========================================================================< Consultar Cep >=======================================================================//
    ...
    private Map<String, String[]> consultarCep(String cep) throws IOException {
        cep = cep.replace("-", "");
...
//==========================================================================< Extrair JSON/END >===================================================================//
    ...
    private Map<String, String[]> extrairDadosJsonEndereco(String json) {
...
//==========================================================================< Extrair JSON/CEP >===================================================================//
    ...
    private Map<String, String[]> extrairDadosJsonCep(String json) {
        Map<String, String[]> dados = new HashMap<>();
...
//==========================================================================< Exibir Resultado/END >===============================================================//

    private void exibirResultadosEndereco(Map<String, String[]> resultados) {
...
//==========================================================================< Exibir Resultado/CEP >===============================================================//

    private void exibirResultadoCep(Map<String, String[]> resultado) {
